...
const seedDB = async () => {
  ...
  for (let i = 0; i < 200; i++) {
    ...
    const newCamp = new Campground({
      ...
      author: "6423183fb5799d8ea4f90d95",
      geometry: {
        type: 'Point',
        coordinates: [
